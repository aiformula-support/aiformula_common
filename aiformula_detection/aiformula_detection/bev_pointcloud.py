...
#from visualization_msgs import MultiPoseArray

class BEVPointCloud(Node):
	def __init__(self):
		super().__init__('bev_pointcloud')
		self.image_sub = self.create_subscription(Image, "ll_result", self.callback_transformer,10)
...
## approximation simulation
		...
		# self.line.extend(line_clusters)
		...
		# colors[labels < 0] = 0
		# self.downpcd.colors = o3d.utility.Vector3dVector(colors[:, :3])
